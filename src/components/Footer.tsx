...
const FooterColumn = ({
  ...
  <div>
    <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
      <div className="w-full px-4 py-2 font-medium text-gray-800 dark:text-gray-200">
        {title}
      </div>
      {items.map((item) => (
        <Link
...
export function Footer() {
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto border-t border-gray-100 dark:border-trueGray-700 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
          <div className="sm:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Simple books. Stronger groups. Vibrant communities.
            </div>
          ...
          <FooterColumn title="Ecosystem" items={ecosystem} />
